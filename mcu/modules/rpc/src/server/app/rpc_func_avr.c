...
ISR(INT0_vect) { isr_trigger_edge(); }

ISR(INT1_vect) { isr_trigger_edge(); }
...
void start_timer(arduino_dig_pin_trigger_t triggered_by,
                 arduino_dig_edge_t edge) {
  timer_init();
...
void define_roundstop_pin(arduino_dig_pin_roundstop_t pin,
                          arduino_dig_edge_t edge) {
